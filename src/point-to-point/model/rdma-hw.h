...
class RdmaHw : public Object {
   public:
    ...
    bool m_rateBound;
    uint32_t m_rx_window;  // tolerance window at receiver (bytes)
    ...
    int ReceiverCheckSeq(uint32_t seq, Ptr<RdmaRxQueuePair> q, uint32_t size, bool &cnp, uint32_t &ack_seq);
